  ...
  return <Box sx={{ whiteSpace: 'normal' }}>
    ...
    <Collapse in={open} id="polygon-measure-panel">
      <Stack spacing={1.5} sx={{ mt: 1 }}>
        <Typography variant="body2">Select a visible polygon to measure its complete database geometry.</Typography>
        ...
        <Box role="status" aria-live="polite">
          ...
          {loading && <Stack direction="row" spacing={1} sx={{ alignItems: 'center' }}><CircularProgress size={16} /><Typography variant="body2">Loading and measuring feature…</Typography></Stack>}
        ...
        <Typography variant="caption" color="text.secondary">GDA2020 / MGA zone 55 (EPSG:7855). Part identifies each polygon; ring 0 is its exterior boundary and later rings are holes.</Typography>
      </Stack>
    </Collapse>
  </Box>
}
